 ...
 */
add_action('init', 'xroom_disable_garbage', 9999);
function xroom_disable_garbage()
{
	/**
	 * disable emojis
	 */
	...
	add_filter( 'tiny_mce_plugins', 'xroom_disable_emojicons_tinymce' );
...
function xroom_disable_emojicons_tinymce( $plugins )
{
	if ( is_array( $plugins ) ) {
 ...
 */
add_action( 'admin_menu', 'xroom_edit_admin_menus', 999 );
function xroom_edit_admin_menus()
{
 ...
 */
add_filter('custom_menu_order', 'xroom_custom_menu_order');
add_filter('menu_order', 'xroom_custom_menu_order');

function xroom_custom_menu_order( $__return_true )
{
	return array(
		'index.php', // Dashboard
		'separator1', // --Space--
